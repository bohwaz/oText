...
function send_emails($id_comment) {
	...
	$article_id = get_entry('commentaires', 'bt_article_id', $id_comment, 'return');
	$article_title = get_entry('articles', 'bt_title', $article_id, 'return');
	$comm_author = get_entry('commentaires', 'bt_author', $id_comment, 'return');
	$comm_author_email = get_entry('commentaires', 'bt_email', $id_comment, 'return');
