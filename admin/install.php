...
function afficher_form_2($erreurs='') {
	...
	echo '</p>'."\n";
	$lien = str_replace('admin/install.php', '', 'http://'.$_SERVER['SERVER_NAME'].$_SERVER['SCRIPT_NAME']);
	echo '<p>';
...
function traiter_install_3() {
	...
	if ($GLOBALS['db_handle']) {
		...
		$link_ar = array(
				...
				'bt_content' => 'Blog du Hollandais Volant, développeur de oText',
				'bt_wiki_content' => 'Blog du Hollandais Volant, développeur de oText.',
				'bt_title' => 'Le Hollandais Volant',
				'bt_link' => 'https://lehollandaisvolant.net/',
				'bt_tags' => 'blog, timo',
				'bt_statut' => '1'
			);
		$link_ar2 = array(
		...
		$comm_ar = array(
			...
			'bt_author' => 'Timo van Neerden',
			'bt_link' => '',
			'bt_webpage' => 'https://lehollandaisvolant.net/',
